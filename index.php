...
<html>
    <head>
        <title>Framing Queensland - Homepage</title>
        <!--Basic Meta Tags-->
        <meta charset="UTF-8">
    ...
    <body>
        <section>
            <div id="skyDesignLogo">
                <a href="html/skydesign.html"><img src="/img/img(png)/logo_blink_02.gif" alt="placeholder logo link" width="200px"/></a>
            </div>
            <h1>
                Framing Queensland
            </h1>

            <img id="helpButton" src="/img/img(png)/instruction_01.png">
            <img id="socialMediaButton" src="/img/img(png)/FBlogo_01.png">

            <div id="photoStack">
                <div id="photoCall">
                    <img src="" alt="The SLQ database cannot be contacted!" width="500px"/>
                </div>
            </div>
            <div id="greetingMsg">
                <p>Hey you! Welcome to Framing Queensland!</p>
                <a href="/html/account.html">Signed in? Click here to check your account</a>
            </div>
            <div id="start">
                <a href="/php/game.php">
                    <button>
